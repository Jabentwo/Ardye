...
?>
	...
	?>
	<!-- 看板娘-->
<script src="https://cdn.jsdelivr.net/gh/acai66/live2d@0.50/autoload.js" async="async"></script>
	<!-- 看板娘-->
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="footer-device">
			...
			<p style="font-family: 'Ubuntu', sans-serif;">
				...
				<!-- 备案信息 -->
						© 2020 Ardye <a href="http://beian.bizcn.com//" target="_blank" style="color:  rgba(0,0,0,.4);;text-decoration:none">湘ICP备2020020719号</a>
				<!-- sitemap -->	
				         | <a href=" https://ardye.com/ardyes-sitemap/" target="_blank">站点地图</a>
						 | <a href="https://ardye.com/sitemap_index.xml" target="_blank">XML MAP</a>
						</p>
